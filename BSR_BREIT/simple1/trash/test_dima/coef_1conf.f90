!======================================================================
      Subroutine Coef_ee_1conf(msh,no,ln,iq,LS,kmax,coefs)
!======================================================================
!     compute the angular coefficients for 1 atomic states;
!     input atomic state and output coefficients are in module coef_LS_1   
!----------------------------------------------------------------------
      Implicit none 

! ... input-output:

      Integer, intent(in) :: msh,no,ln(*),iq(*),LS(msh,5),kmax
